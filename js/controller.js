var Controller = function (model, view) {
	$('body')
		.on('click', '.glyphicon-plus, .glyphicon-minus', function (e) {
		...
		.on('click', '.glyphicon-plus-sign', function(e) {
			var newNode = model.addNode($(this));

			view.addNode($(this), newNode);
			model.saveTree();
		})
		.on('click', '.glyphicon-minus-sign', function(e) {
